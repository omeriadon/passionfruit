...
- `wirelessStandards` — any — required
- `fastChargeMinutesToPercent` — any — required
...
- `inputVoltageRangeV` — any — required
...
- `wifi` — any — required
- `bluetooth` — any — required
- `cellular` — any — required
- `uwb` — any — required
- `thread` — any — required
- `infrared` — any — required
- `nearFieldCommunication` — any — required
- `gps` — any — required
- Additional properties: disallowed
...
- `hearingHealth` — array of string — required
- `liveTranslation` — array of string — required
